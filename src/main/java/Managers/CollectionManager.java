...
public class CollectionManager {
    ...
    public void addElement(Organization organization) throws InvalidFormException {
     ...
     */
    public ArrayDeque<Organization> exportCollection(){
        ArrayDeque<Organization> copyOfCollection= new ArrayDeque<>(collection);
        return ((ArrayDeque<Organization>) Collections.unmodifiableCollection(copyOfCollection));
    }
    ...
    public void editById(int id, Organization newObj) throws InvalidFormException{
    ...
    public void loadCollection() throws ExitPoint {
        ...
        Organization.updateNextId(collection);
        lastInitTime = LocalDateTime.now();
    }
