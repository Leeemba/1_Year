...
public enum ConsoleFormat {
    ...
    /**
     * @deprecated
     * Нереализованная функциональность. Метод предназначался для возможной выборки цветовой палитры пользователем вначале программы
     * @return название элемента перечисления на русском
     */
