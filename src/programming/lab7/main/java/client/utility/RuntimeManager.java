...
public class RuntimeManager {
    ...
    public RuntimeManager(Console console,UDPClient client){
        ...
        this.commands = new HashMap<>(){{
                ...
                put(CommandNames.AUTHENTICATE,new Authenticate(console,client));
                put(CommandNames.REGISTER,new Register(console,client));
        }};
    }
    ...
    public void interactiveMode(){
        ...
        console.printHint(Hint.AUTHHINT.toString());
        console.printHint(Hint.REGHINT.toString());
        console.printHint(Hint.EXECHINT.toString());
