...
public class Organization implements  Validator, Serializable {
    ...
    public Organization(String name,LocalDate creationDate,Coordinates coordinates,Integer annualTurnover, String fullName, OrganizationType type, Address postalAddress) {
        this.name = name;
    ...
    public Organization(String name,LocalDate creationDate,Coordinates coordinates,Integer annualTurnover, String fullName, OrganizationType type, Address postalAddress,String creator) {
        this.name = name;
        this.coordinates = coordinates;
        this.annualTurnover = annualTurnover;
        this.fullName = fullName;
    ...
    public Organization copyCollWithId(int creatorId){
        return new Organization(this.name,this.creationDate,this.coordinates,this.annualTurnover,this.fullName,this.type,this.postalAddress,this.creator);
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getId(), that.getId()) && Objects.equals(getName(), that.getName()) && Objects.equals(getCoordinates(), that.getCoordinates()) && Objects.equals(getCreationDate(), that.getCreationDate()) && Objects.equals(getAnnualTurnover(), that.getAnnualTurnover()) && Objects.equals(getFullName(), that.getFullName()) && getType() == that.getType() && Objects.equals(getPostalAddress(), that.getPostalAddress()) && Objects.equals(creator, that.creator);
    }

    @Override
    public int hashCode() {
        return Objects.hash(getId(), getName(), getCoordinates(), getCreationDate(), getAnnualTurnover(), getFullName(), getType(), getPostalAddress(), creator);
    }
