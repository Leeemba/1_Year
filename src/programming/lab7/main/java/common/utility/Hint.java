...
public enum Hint {
    ...
    AUTHHINT("Для аутентификации пользователя введите команду\"authenticate\""),
    REGHINT("Для регистрации нового пользователя введите команду \"register\""),
    EXECHINT("Для исполнения скрипта введите команду\"execute_script\"");
   String description;
